...
by Sanger and Coulson in 1975}\label{fig:+/-}
\end{figure}
...
labeled nonomer witht eh query position shifted one base can be ligated. 

\begin{figure}[H]
\centering
    \includegraphics[width=.5\textwidth]{images/Polony.pdf}
    \caption{}\label{fig:MGchem} 
\end{figure}
