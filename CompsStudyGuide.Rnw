...
that uses colony amplification of DNA fragments on a flowcell combined with erversible terminator nucleotides 
...
\begin{figure}[H]
\centering
    \includegraphics[width=.5\textwidth]{images/Solexa.pdf}
